    ...
    \job
        ...
        {\begin{itemize}
         ...
         \item A main contributor of the GAMER,
               a hybrid \colorbox{yellow!30}{GPU/OpenMPI/OpenMP} program
               for hydrodynamic simulations.\\
               \footnotesize
               (\textcolor{violet}
               {\url{https://github.com/gamer-project/gamer/graphs/contributors}})
         \normalsize
         \item Designed a new approach to further promote the robustness of our
               program (GAMER) for research.
