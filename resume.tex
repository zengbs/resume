...
\tagline{\textcolor{red}{6+} years experience of large-scale software development
         with \textcolor{red}{C} programming on the \textcolor{red}{Linux} system
         throughout my Ph.D. journey.
         Seeking a challenging and rewarding opportunity with
         low-level system programming
         (eg. \textcolor{red}{device driver, Linux kernel, CPU architecture})
