...
\mainbar{
    ...
    \job{08/2016 - 06/2022}
        ...
        {\begin{itemize}
         ...
         \item Designed a new approach to further promote the robustness of GAMMER.
               The new approach was adopted in a research project led
               by Dr. Kuo-Chuan Pan from Tsing Hua University.\\
               See the merged branch: (\url{https://github.com/gamer-project/gamer/pull/60/files})\\
         ...
         \item A main contributor of the gammer-project on GitHub.\\
               See: (\url{https://github.com/gamer-project/gamer/graphs/contributors})\\
         \item Built NIS, NFS, and Linux cluster from scratch with colleagues
               and worked with Dr. Schive to bootstrap simulations for research.
         \end{itemize}}
