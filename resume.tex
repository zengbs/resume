...
\publication
	...
	{\ADS{https://ui.adsabs.harvard.edu/abs/2021MNRAS.504.3298T/abstract},
         \arXiv{https://arxiv.org/abs/2012.11130}} % ADS & arxiv links
...
\begin{itemize}
   \item  An adaptive-mesh, GPU-accelerated, and optimally error-controlled
          special relativistic hydrodynamics code\\
       	  Oral, American Center for Physics College Park, Maryland, United States        Mar. 2021
   \item  A new and accurate code for simulating special relativistic hydrodynamics\\
          Oral, Annual Meeting of the Physical Society of Taiwan, NPTU.        Feb. 2020
\end{itemize}
\section{References}
\begin{itemize}
